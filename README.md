...
Intelligently handles Load-Use dependencies and branch penalties using stalls.

#### Branch Flush:

Implements a flushing mechanism to clear the pipeline upon taken branches, ensuring instruction integrity.

### Integrated Cache System:

**Direct-Mapped Cache**: 64-line cache with a Write-Through policy.

#### Cache Controller:

Handles Cache Misses by stalling the entire pipeline until data is fetched from Main Memory.
